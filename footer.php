...
<div id="footer">
	...
	<?php if( is_page_template( 'page-contact.php' ) ) : ?>
		<?php get_template_part( 'templates/location-directions' ) ?>
	<?php endif; ?>
	...
	<div class="fb2">
		<div class="cntr">
			<ul class="social">
				<?php if( get_field('wb_ts_social_media__facebook','option') ) { ?>
					<li>
						<a href="<?php the_field('wb_ts_social_media__facebook','option'); ?>" target="_blank">
							<i class="fa fa-facebook"></i>
						</a>
					</li>
				<?php } ?>
				<?php if( get_field('wb_ts_social_media__twitter','option') ) { ?>
					<li class="twitter">
						<a href="<?php the_field('wb_ts_social_media__twitter','option'); ?>" target="_blank">
							<i class="fa fa-twitter"></i>
						</a>
					</li>
				<?php } ?>
				<?php if( get_field('wb_ts_social_media__linkedin','option') ) { ?>
					<li>
						<a href="<?php the_field('wb_ts_social_media__linkedin','option'); ?>" target="_blank">
							<i class="fa fa-linkedin"></i>
						</a>
					</li>
				<?php } ?>
				<?php if( get_field('wb_ts_social_media__google_plus','option') ) { ?>
					<li class="twitter">
						<a href="https://plus.google.com/<?php the_field('wb_ts_social_media__google_plus','option'); ?>" target="_blank" rel="publisher">
							<i class="fa fa-google-plus"></i>
						</a>
					</li>
				<?php } ?>
				<?php if( get_field('wb_ts_social_media__instagram','option') ) { ?>
					<li>
						<a href="<?php the_field('wb_ts_social_media__instagram','option'); ?>" target="_blank">
							<i class="fa fa-instagram"></i>
						</a>
					</li>
				<?php } ?>
				<?php if( get_field('wb_ts_social_media__pinterest','option') ) { ?>
					<li>
						<a href="<?php the_field('wb_ts_social_media__pinterest','option'); ?>" target="_blank">
							<i class="fa fa-pinterest"></i>
						</a>
					</li>
				<?php } ?>
				<?php if( get_field('wb_ts_social_media__youtube','option')  ) { ?>
					<li>
						<a href="<?php the_field('wb_ts_social_media__youtube','option'); ?>" target="_blank">
							<i class="fa fa-youtube"></i>
						</a>
					</li>
				<?php } ?>
				<?php if( get_field('wb_ts_social_media__vimeo','option') ) { ?>
					<li>
						<a href="<?php the_field('wb_ts_social_media__vimeo','option'); ?>" target="_blank">
